    ...
    <section id="tema-skripsi" className="feature pt-50 pb-50">
      <div className="container-fluid">
        ...
        <div className="row gap-lg-0 gap-4" data-aos="fade-up">
          ...
          <StepItem icon="iot" title="5. Internet Of Thinks" desc1="Sebuah konsep yang sederhananya menggambarkan perangkat-perangkat yang " desc2="terhubung satu sama lainnya melalui jaringan internet.  " />
